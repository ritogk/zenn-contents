...
この記事は、[FOSS4G Advent Calendar 2023](https://qiita.com/advent-calendar/2023/foss4g) の25日目です。
...
これまでの処理をベースにして、評価関数を「`頭文字Dで走るような峠`」に変更したものがこちらになります。
osm以外に[国土地理院さんの標高モデル](https://fgd.gsi.go.jp/download/menu.php)も使っています。
赤色が強い所ほど「`頭文字Dで走るような峠`」の特徴が強いです。
